...
private:
    ...
    // activation radius per TV camera (squared). 0 means disabled.
    static std::vector<float> m_tv_radius2;
    static float m_tv_default_radius2; // squared default radius if provided at root level
